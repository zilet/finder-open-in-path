--
--  MVimInPathAppDelegate.applescript
--  OpenMVimInPath
--
	...
	on applicationWillFinishLaunching_(aNotification)
		tell application "Finder"
            try
                ...
                set theCommand to "open -a 'MacVim'  " & myPath
                do shell script theCommand
                on error errStr number errorNumber
                display dialog "Whooa.. something went wrong. Please select a file or folder" & errStr
            end try
        end tell
        quit
